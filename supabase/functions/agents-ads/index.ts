...
function buildBackgroundPrompt(
  ...
  if (bgSource === "reference" && hasRefImages) {
    ...
    sourceBlock = [
      "████ BACKGROUND SOURCE: COMPANY BRAND POSTS — MATCH THE BRAND'S DESIGN LANGUAGE ████",
      "The attached image(s) are this brand's own social ads. Study them to learn the brand's DESIGN LANGUAGE and REPRODUCE it, while building a NEW scene for THIS campaign. The result must look like it belongs in this brand's feed.",
      "",
      "REPRODUCE THE BRAND'S DESIGN ASSETS (this IS the brand identity — it must be recognizable, do NOT strip it):",
      "• The recurring DECORATIVE assets the brand uses across its posts — dot grids, brand-color panels / diagonal color fields, strokes & lines, small geometric shapes, icon/emoji accents — REPRODUCE them in the brand colors so the ad is unmistakably this brand's.",
      "• Match the color palette and grading, lighting mood, photographic/rendering treatment, and composition language of the posts.",
      "• Use these as IDENTITY DECORATION — framing, corners, an accent strip or field, background texture. They should be clearly PRESENT and recognizable, but tasteful: a confident amount, not a chaotic pile covering the whole canvas. Always leave a clean area for the overlaid text.",
      "",
      "THE HERO SUBJECT = THIS CAMPAIGN'S TOPIC (the brand assets DECORATE around it; they are never the product):",
      "• Build ONE clear, relevant hero subject that represents THIS campaign's product/service (see CAMPAIGN CONTEXT). For social-media management → a phone showing a social feed, a laptop with an analytics/engagement dashboard, a content-creation desk, growth/metrics visuals. It must be OBVIOUSLY about the campaign topic — not a random object.",
      "• The brand's decorative assets sit around/behind the subject as identity; the subject itself is the campaign theme, in sharp focus.",
      "",
      "NEVER COPY THESE FROM THE REFERENCES (they ruin the ad):",
      "• ⛔ TEXT — no headlines, slogans, captions, numbers, watermarks or copyright lines (e.g. NO '© ... BTS / HYBE ...', NO 'X signs your website...'). The reference ads have burned-in copy; your image must contain ZERO text.",
      "• ⛔ THE LOGO / WORDMARK — never draw, trace, or place the brand name/logo anywhere (it is composited separately on top; drawing it makes it appear twice).",
      "• ⛔ PEOPLE / FACES / CELEBRITIES — never copy or recreate any person, face, model or celebrity shown in the posts (e.g. the music artist in the references). If the scene genuinely needs a person, use a generic, non-identifiable one — never one from the references.",
      "",
      "Compose fresh for this format. Final image = the brand's decorative design assets + a campaign-relevant hero subject. ENTIRELY TEXT-FREE and LOGO-FREE.",
    ].join("\n");
  ...
  return [
    ...
    "• Brand decoration: reproduce the brand's own recurring design assets (dot grids, strokes/lines, brand-color panels or diagonal fields, small icon/emoji accents) as tasteful IDENTITY decoration — clearly present so the ad is on-brand, but not covering the whole canvas, never overlapping the reserved text zone, and never replacing the hero subject. On-brand and confident, not a random pile of unrelated effects (sparkles + confetti + glow + badges all at once).",
        ...
        try {
          const brandQuery = await callGemini(
            [
              ...
              "Extract the brand's visual style in TWO parts. (a) DESIGN ASSETS — the recurring decorative devices the brand uses across its posts (e.g. dot grids, brand-color panels/diagonal fields, strokes/lines, small geometric shapes, icon/emoji accents) plus the color palette and grading, lighting, and photographic/rendering treatment. List the recurring assets concretely so they can be reproduced as the brand's identity decoration. (b) SUBJECT TREATMENT — how subjects are framed, cropped, lit, and where they sit, and the use of negative space. Be specific (e.g. 'coral-red background with an orange dot grid in one corner, white diagonal panel, product photo bottom-right, generous calm space top-left'). Describe the decoration as IDENTITY accents around the subject — never as the subject itself, and never any burned-in text, logo or person to copy.",
              "",
