        ...
        foreach (($b['formats'] ?? []) as $iF => $fmtC) {
            ...
            $bannersC[] = [
                ...
                'debug'         => [
                    ...
                    // foi tratada como PRIMARIA no prompt (estilo/composicao/paleta), em vez de
                    // pesar igual aos brand_posts - e' quando a clausula anti-retrato tambem entra
                    // (nunca reproduzir rosto/pessoa real da referencia, so' o estilo dela).
